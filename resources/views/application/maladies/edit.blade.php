...
<form action="{{ route('maladie.update', ['id' => $data->id]) }}" method="POST" id="form">
    @csrf
    @method('PATCH')
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nomMaladie" placeholder="nom maladie" class="form-control" value="{{ $data->nomMaladie }}" required>
                    </div>
                </div>
            </div>
        </div>
