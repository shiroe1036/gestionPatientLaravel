            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group{{ $errors->has('prenom') ? 'has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" name="prenom" value="{{ old('prenom') }}" required autofocus>
                ...
                <div class="col-sm-6">
                    <div class="form-group{{ $errors->has('tel') ? 'has-error' : '' }}">
                        ...
                        <input type="number" class="form-control" name="tel" value="{{ old('tel') }}" required autofocus>
                    ...
                    <div class="form-group {{ $errors->has('typeUtilisateur') ? 'has-error' : '' }}">
                        ...
                        <select name="typeUtilisateur" id="typeUtilisateur" required autofocus class="form-control">
                            ...
                            @if(Auth::user()->typeUtilisateur != 'superAdmin')
                                <option value="superAdmin" {{ old('remember') ? 'selected' : '' }}>Super utilisateur</option>
                            @endif
                            <option value="chefDeService" {{ old('remember') ? 'selected' : '' }}>Chef de service</option>
                            <option value="medecin" {{ old('remember') ? 'selected' : '' }}>Médecin</option>
                            <option value="secretaire" {{ old('remember') ? 'selected' : '' }}>Sécrétaire</option>
                        </select>
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-sm-9 col-sm-offset-3">
                    ...
                    <a href="{{ route('utilisateur.index') }}" class="btn btn-default">Annuler</a>
                </div>
            </div>
        </div>
    </section>
